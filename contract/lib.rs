...
// inheriting other file
pub mod constant;
pub mod states;

// crate : like npm  (package manager)
use crate::{constant::*, states::*};

// Is the program address
declare_id!("EbxNTtwo9YU1v9fhXJfkuHCXVysbEMwdgEyKjy6Fcw4e");

// programın talimat mantığını içeren modülü belirtmek için kullanılan bir nitelik makrosu
// blog_sol: contract name
// {*****} : * = instructions
#[program]
pub mod blog_sol {
    use super::*;
